...
Div8r:
	ldhx	syncTime	; Get the 128 clock time
	pshh 			; move values for math function
	txa
	pulx
  
	lsrx			; divide 128 target BDC clock period by 8
	rora			;  for the 16 clock value
	lsrx 
	rora
	lsrx 
	rora
	adc	#0		; round value up
	bcc	bgndTC01
...
bits0_5:
	...
	;bsr delay2BDC;            ; Delays 2 BDC cycles after every bit tranmission to 
